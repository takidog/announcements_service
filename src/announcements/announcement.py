...
class AnnouncementService:
    ...
    def delete_announcement(self, announcement_id: int, force_delete=False) -> bool:
        ...
        self.redis_announcement.delete(announcement_name_search)
    ...
    def _get_announcement_key_name_by_id(self, announcement_id: int, raise_error=False) -> list:
        ...
        Returns:
            list: key name list
        """
        if self.redis_announcement.exists(f'announcement_{announcement_id}'):
            return f'announcement_{announcement_id}'
